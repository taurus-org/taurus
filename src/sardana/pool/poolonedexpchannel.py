...
from poolacquisition import Pool1DAcquisition


class Pool1DExpChannel(PoolElement):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_action_cache(Pool1DAcquisition(self, name=acq_name))
    ...
    value = property(get_value, set_value, doc="1D value")
