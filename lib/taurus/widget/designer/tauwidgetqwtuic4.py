...
def moduleInformation():
    moduleName = "taurus.widget.qwt"
    widgetNames = []

    import PyQt4.QtGui
    import taurus.widget.qwt

    for name in taurus.widget.qwt.__dict__.keys():
        if name.startswith("Tau"):
            kls = taurus.widget.qwt.__dict__[name]
            try:
