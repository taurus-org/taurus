...
class MainWindow(QtGui.QMainWindow):
    ...
    def __init__(self, frontend, existing=False, may_close=True,
                    confirm_exit=True):
...
qt_flags = {
    'existing' : ({'TaurusConsoleApp' : {'existing' : True}},
            "Connect to an existing kernel."),
    'pure' : ({'TaurusConsoleApp' : {'pure' : True}},
...
qt_flags.update(boolean_flag(
    'confirm-exit', 'TaurusConsoleApp.confirm_exit',
...
qt_aliases = dict(
    hb = 'TaurusConsoleApp.hb_port',
    shell = 'TaurusConsoleApp.shell_port',
    iopub = 'TaurusConsoleApp.iopub_port',
    stdin = 'TaurusConsoleApp.stdin_port',
    ip = 'TaurusConsoleApp.ip',

    style = 'IPythonWidget.syntax_style',
    stylesheet = 'TaurusConsoleApp.stylesheet',
...
class TaurusConsoleApp(BaseIPythonApplication):
    ...
    def parse_command_line(self, argv=None):
        super(TaurusConsoleApp, self).parse_command_line(argv)
        if argv is None:
            argv = sys.argv[1:]
    ...
    def init_qt_elements(self):
        ...
        #self.window = MainWindow(self.widget, self.existing,
        #                        may_close=local_kernel,
        #                        confirm_exit=self.confirm_exit)
        title = ('Python' if self.pure else 'IPython')
    ...
    def initialize(self, argv=None):
        super(TaurusConsoleApp, self).initialize(argv)
