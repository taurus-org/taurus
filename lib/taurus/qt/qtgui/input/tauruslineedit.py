...
class TaurusValueLineEdit(Qt.QLineEdit, TaurusBaseWritableWidget):
    """
    A taurus-aware QLineEdit. It will display the value (or fragment of the
    value) referenced by its model. It is a :class:`TaurusBaseWritableWidget`
    ...
    extended behaviour:
      ...
      - It the mouse wheel and keyboard arrows can be enabled for doing value
      increments

    ..note:: when used with models whose value is a pint `Quantity`, the text
