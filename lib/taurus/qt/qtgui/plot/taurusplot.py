...
def main():
    ...
    parser.add_option("--import", "--import-file", dest="import_file", default=None,
    ...
    if options.import_file is not None:
        w.importAscii([options.import_file],xcol=0)
    ...
    if len(models) == 0 and options.config_file is None and options.import_file is None:
        w.showDataImportDlg()
