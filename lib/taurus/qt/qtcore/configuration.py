...
#class TaurusBaseConfigurableClass(BaseConfigurableClass):
#    ''' 
#    A specialized :class:`BaseConfigurableClass` that assumes that the object
#    is also deriving from TaurusBaseComponent, and therefore stores Taurus-related
#    configurations like the model, etc
#    '''
#    def __init__(self):
#        BaseConfigurableClass.__init__(self)
#        self.registerConfigProperty("getUseParentModel", "setUseParentModel", "useParentModel")
#        self.registerConfigProperty("getModelName", "setModel", "model")
#        self.registerConfigProperty("isModifiableByUser", "setModifiableByUser", "modifiableByUser")
#        
#        
##    def createConfig(self, allowUnpickable=False):
##        '''
##        extends :meth:`BaseConfigurableClass.createConfig` to store basic
##        TaurusBaseComponent configurations
##                
##        :param alllowUnpickable:  (bool) 
##        
##        :return: (dict<str,object>) configurations (which can be loaded with
##                 :meth:`applyConfig` 
##        
##        .. seealso: :meth:`applyConfig` , :meth:`registerConfigurableItem`, 
##                    :meth:`BaseConfigurableClass.createConfig`
##        '''
##        configdict = BaseConfigurableClass.createConfig(self, allowUnpickable=allowUnpickable)
##        configdict["model"] = self.getModelName()
##        configdict["useParentModel"] = self.getUseParentModel()
##        configdict["modifiableByUser"] = self.isModifiableByUser()
##        return configdict
##    
##    def applyConfig(self, configdict, **kwargs):
##        """
##        extends :meth:`BaseConfigurableClass.applyConfig` to restore basic
##        TaurusBaseComponent configurations
##        
##        :param configdict: (dict)
##        
##        .. seealso:: :meth:`BaseConfigurableClass.applyConfig` ,
##                     :meth:`createConfig`
##        """
##        BaseConfigurableClass.applyConfig(self, configdict, **kwargs)
##        self.setUseParentModel(configdict.get("useParentModel",False))
##        #self.setModel(configdict.get("model",None))  #This is commented out because it causes problems with, at least, TaurusForms
##        self.setModifiableByUser(configdict.get("modifiableByUser",False))
