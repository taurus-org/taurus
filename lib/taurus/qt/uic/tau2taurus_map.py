...
TAU_2_TAURUS_LIST = [
    ["tau.widget", "AbstractGraphicsFactory",
        "taurus.qt.qtgui.graphic", "TaurusBaseGraphicsFactory"],
    ["tau.widget", "ActionFactory", "taurus.qt.qtgui.util", "ActionFactory"],
    ["tau.widget", "BaseConfigurableClass",
        "taurus.qt.qtcore.configuration", "BaseConfigurableClass"],
    ...
    ["tau.widget", "QT_ATTRIBUTE_QUALITY_PALETTE",
        "taurus.qt.qtgui.util", "QT_ATTRIBUTE_QUALITY_PALETTE"],
    ["tau.widget", "QT_DEVICE_STATE_PALETTE",
        "taurus.qt.qtgui.util", "QT_DEVICE_STATE_PALETTE"],
    ["tau.widget", "Release", "taurus.core", "Release"],
    ["tau.widget", "TauAttrForm", "taurus.qt.qtgui.panel", "TaurusAttrForm"],
    ["tau.widget", "TauAttrListComboBox",
    ...
    ["tau.widget", "TauBaseContainer",
        "taurus.qt.qtgui.container", "TaurusBaseContainer"],
    ["tau.widget", "TauBaseWidget", "taurus.qt.qtgui.base", "TaurusBaseWidget"],
    ["tau.widget", "TauBaseWritableWidget",
        "taurus.qt.qtgui.base", "TaurusBaseWritableWidget"],
    ...
    ["tau.widget", "TauConfigLineEdit",
        "taurus.qt.qtgui.input", "TaurusConfigLineEdit"],
    ["tau.widget", "TauDevTree", "taurus.qt.qtgui.tree", "TaurusDevtree"],
    ["tau.widget", "TauEllipseStateItem",
        "taurus.qt.qtgui.graphic", "TaurusEllipseStateItem"],
    ["tau.widget", "TauForm", "taurus.qt.qtgui.panel", "TaurusForm"],
    ["tau.widget", "TauFrame", "taurus.qt.qtgui.container", "TaurusFrame"],
    ["tau.widget", "TauGraphicsAttributeItem",
        "taurus.qt.qtgui.graphic", "TaurusGraphicsAttributeItem"],
    ["tau.widget", "TauGraphicsItem", "taurus.qt.qtgui.graphic", "TaurusGraphicsItem"],
    ["tau.widget", "TauGraphicsScene",
        "taurus.qt.qtgui.graphic", "TaurusGraphicsScene"],
    ["tau.widget", "TauGraphicsStateItem",
        "taurus.qt.qtgui.graphic", "TaurusGraphicsStateItem"],
    ...
    ["tau.widget", "TauGroupStateItem",
        "taurus.qt.qtgui.graphic", "TaurusGroupStateItem"],
    ["tau.widget", "TauJDrawSynopticsView",
        "taurus.qt.qtgui.graphic", "TaurusJDrawSynopticsView"],
    ["tau.widget", "TauLCDValue", "taurus.qt.qtgui.display", "TaurusLCD"],
    ["tau.widget", "TauLauncherButton",
    ...
    ["tau.widget", "TauPolygonStateItem",
        "taurus.qt.qtgui.graphic", "TaurusPolygonStateItem"],
    ["tau.widget", "TauPropTable", "taurus.qt.qtgui.table", "TaurusPropTable"],
    ["tau.widget", "TauQueryComboBox", "None", "None"],
    ["tau.widget", "TauRectStateItem",
        "taurus.qt.qtgui.graphic", "TaurusRectStateItem"],
    ...
    ["tau.widget", "TauTextAttributeItem",
        "taurus.qt.qtgui.graphic", "TaurusTextAttributeItem"],
    ["tau.widget", "TauTextStateItem",
        "taurus.qt.qtgui.graphic", "TaurusTextStateItem"],
    ...
    ["tau.widget.actions", "AttributeAllConfigAction",
        "taurus.qt.qtgui.util", "AttributeAllConfigAction"],
    ["tau.widget.actions", "AttributeDisplayAction",
        "taurus.qt.qtgui.util", "AttributeDisplayAction"],
    ["tau.widget.actions", "AttributeHistoryAction",
        "taurus.qt.qtgui.util", "AttributeHistoryAction"],
    ["tau.widget.actions", "AttributeImageDisplayAction",
        "taurus.qt.qtgui.util", "AttributeImageDisplayAction"],
    ["tau.widget.actions", "AttributeMenu",
        "taurus.qt.qtgui.util", "AttributeMenu"],
    ["tau.widget.actions", "AttributeMonitorDeviceAction",
        "taurus.qt.qtgui.util", "AttributeMonitorDeviceAction"],
    ["tau.widget.actions", "AttributeRangesAction ",
        "taurus.qt.qtgui.util", "AttributeRangesAction "],
    ["tau.widget.actions", "AttributeUnitsAction",
        "taurus.qt.qtgui.util", "AttributeUnitsAction"],
    ["tau.widget.actions", "ConfigurationMenu",
        "taurus.qt.qtgui.util", "ConfigurationMenu"],
    ["tau.widget.actions", "SeparatorAction",
        "taurus.qt.qtgui.util", "SeparatorAction"],
    ["tau.widget.actions", "TauAction", "taurus.qt.qtgui.util", "TauAction"],
    ["tau.widget.actions", "TauMenu", "taurus.qt.qtgui.util", "TauMenu"],
    ["tau.widget.configbrowser", "ConfigViewer",
        "taurus.qt.qtgui.panel", "QConfigViewer"],
    ["tau.widget.dialog", "AttrChooser",
        "taurus.qt.qtgui.panel", "TaurusAttributeChooser"],
    ["tau.widget.dialog", "DataExportDlg",
        "taurus.qt.qtgui.panel", "QDataExportDialog"],
    ["tau.widget.dialog", "RawDataWidget",
        "taurus.qt.qtgui.panel", "QRawDataWidget"],
    ...
    ["tau.widget.extra_motor", "TauMotorH",
        "taurus.qt.qtgui.extra_pool", "TaurusMotorH"],
    ["tau.widget.extra_motor", "TauMotorH2",
        "taurus.qt.qtgui.extra_pool", "TaurusMotorH2"],
    ["tau.widget.extra_motor", "TauMotorV",
        "taurus.qt.qtgui.extra_pool", "TaurusMotorV"],
    ["tau.widget.extra_motor", "TauMotorV2",
        "taurus.qt.qtgui.extra_pool", "TaurusMotorV2"],
    ["tau.widget.extra_motor", "PoolMotorSlim",
        "taurus.qt.qtgui.extra_pool", "PoolMotorSlim"],
    ["tau.widget.macroexecutor", "TauMacroExecutorWidget",
        "taurus.qt.qtgui.extra_macroexecutor", "TaurusMacroExecutorWidget"],
    ["tau.widget.macroexecutor", "TauMacroExecutor",
        "taurus.qt.qtgui.extra_macroexecutor", "TaurusMacroExecutor"],
    ["tau.widget.macroexecutor", "TauSequencer",
        "taurus.qt.qtgui.extra_macroexecutor", "TaurusSequencer"],
    ["tau.widget.macroexecutor", "TauMacroConfigurationDialog",
        "taurus.qt.qtgui.extra_macroexecutor", "TaurusMacroConfigurationDialog"],
    ["tau.widget.macroexecutor", "TauMacroDescriptionViewer",
        "taurus.qt.qtgui.extra_macroexecutor", "TaurusMacroDescriptionViewer"],
    ["tau.widget.macroexecutor", "DoorOutput",
        "taurus.qt.qtgui.extra_macroexecutor", "DoorOutput"],
    ["tau.widget.macroexecutor", "DoorDebug",
        "taurus.qt.qtgui.extra_macroexecutor", "DoorDebug"],
    ["tau.widget.macroexecutor", "DoorResult",
        "taurus.qt.qtgui.extra_macroexecutor", "DoorResult"],
]
