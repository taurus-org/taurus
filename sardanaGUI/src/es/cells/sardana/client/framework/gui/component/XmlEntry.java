...
public final class XmlEntry
{
    ...
    public XmlEntry(XmlObject xml)
    {
        ...
        String lbl = cursor.getAttributeText(new QName("label"));
        if (lbl == null || lbl.equals(""))
        {
        	lbl = cursor.getAttributeText(new QName("alias"));
            if (lbl == null || lbl.equals(""))
            {
            	lbl = cursor.getAttributeText(new QName("name"));
	            if (lbl == null || lbl.equals(""))
	            {
	            	lbl = cursor.getAttributeText(new QName("deviceName"));
	            }
            }
        }
