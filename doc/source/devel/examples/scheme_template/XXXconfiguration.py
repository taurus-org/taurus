...
##
#############################################################################
__all__ = ["YYYConfiguration"]

"""
For create your basic scheme configuration.
...
class YYYConfiguration(TaurusConfiguration):
    '''
    ...
    .. warning:: In most cases this class should not be instantiated directly.
                 Instead it should be done via the :meth:`YYYFactory.getConfig`
    '''
